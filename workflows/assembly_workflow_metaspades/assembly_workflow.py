...
# Parse arguments
workflow = Workflow(version="0.1", description="Spades workflow")
...
workflow.add_argument("spades-options", desc='metaSPADES options as a text string with quotes', default="")
...
try:
	os.environ["SPADES_BIN"]
except:
	raise ValueError("SPADES_BIN not provided or set")
