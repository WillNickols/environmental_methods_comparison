...
dir.create(paste0("analysis/figure2/thresholding2/"), showWarnings = FALSE, recursive = T)
write.table(out_df, "analysis/figure2/thresholding2/thresholds.tsv", sep="\t", row.names = F)
...
phyla_example <- function() {
  ...
  ggsave(paste0("analysis/figure2/overview_figure2/sim_phylum.png"), width=15, height=13.5, units = 'cm', dpi=1000)
}
phyla_example()
...
simulation_explanation <- function() {
  ...
  dir.create(paste0("analysis/figure2/simulation_setup/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/simulation_setup/","simulation_setup.png"), p1, width=6, height=18, units = 'cm', dpi=1000)
}
...
simulation_explanation_by_tool <- function() {
  ...
  dir.create(paste0("analysis/figure2/simulation_setup/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/simulation_setup/","simulation_setup_by_tool.png"), p1, width=44, height=18, units = 'cm', dpi=1000)
}
...
prf1_summary <- function(ncbi_only, core_five = FALSE) {
  ...
  for (level in c(2, 5, 7)) {
    for (dataset in list.files("analysis/simulation_outputs")) {
      ...
      for (i in 1:length(profiles)) {
        ...
        df_addition <- data.frame(cbind(tool_names[i], dataset, level, "BC", 1 - calc_bc_sim(profiles[[i]], truth, dist_type = "jaccard")[standards]))
        colnames(df_addition) <- c("Tool", "Dataset", "Level", "Metric", "Value")
        plot_df <- rbind(plot_df, df_addition)
      }
    }
  ...
  plot_df$Metric[plot_df$Metric == "BC"] <- "1 - Jaccard dissimilarity"
  ...
  p1 <- ggplot(plot_df, aes(x=Tool, y=Value, fill=Tool)) + 
    ...
    facet_nested(Dataset ~ factor(Metric, c("F1", "1 - Jaccard dissimilarity")) + Level) +
    theme_linedraw() + 
    ylim(0, 1) + 
  ...
  ggsave(paste0("analysis/figure2/simulation_core/f1_and_jc_", ncbi_only, "_", core_five, ".png"), p1, width = 10, height = 6)
}

if (!file.exists(paste0("analysis/figure2/simulation_core/f1_and_jc_", "NCBI_only", "_core_tools.png"))) {
  prf1_summary(TRUE)
  prf1_summary(TRUE, TRUE)
}
if (!file.exists(paste0("analysis/figure2/simulation_core/f1_and_jc_", "all_taxa", "_all_tools.png"))) {
  prf1_summary(FALSE)
  prf1_summary(FALSE, TRUE)
}

# Show how JC dissimilarity from true profile changes with sample features
bray_vs_parameter_individual <- function(dataset, level, ncbi_only=TRUE) {
  ...
  for (i in 1:length(profiles)) {
    ...
    df_append <- data.frame(tool_names[i],
                             ...
                             1 - calc_bc_sim(profiles[[i]], truth, dist_type = "jaccard")
                             )
  ...
  p1 <- ggplot(bray_df[bray_df$sample_size==default_params["sample_size"] & bray_df$unknown==default_params["unknown"] & bray_df$k==default_params["k"] & bray_df$sigma==default_params["sigma"] & bray_df$mut_rate==default_params["mut_rate"],], 
    ...
    theme_classic() + 
    ylab(paste0("1 - Jaccard dissimilarity\nat the ", level_name, " level")) + 
    xlab("Species count") + 
    col + 
  ...
  ncbi_only <- ifelse(ncbi_only, "NCBI_only", "all_taxa")
  dir.create(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/n/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/n/",dataset,"_",level_name,"_",ncbi_only, ".png"), p1, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/sample_size/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/sample_size/",dataset,"_",level_name,"_",ncbi_only, ".png"), p2, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/unknown_prop/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/unknown_prop/",dataset,"_",level_name,"_",ncbi_only, ".png"), p3, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/mut_rate/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/mut_rate/",dataset,"_",level_name,"_",ncbi_only, ".png"), p4, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/k/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/k/",dataset,"_",level_name,"_",ncbi_only, ".png"), p5, width=20, height=20, units = 'cm', dpi=1000)
  ...
  p6 <- ggplot(bray_df[bray_df$n==default_params["n"] & bray_df$sample_size==default_params["sample_size"] & bray_df$unknown==default_params["unknown"] & bray_df$k==default_params["k"] & bray_df$mut_rate==default_params["mut_rate"],], 
    ...
    theme(text=element_text(size=12),
          ...
          legend.text = element_text(size=10)) + 
    guides(color=guide_legend(title="Tool"))
  dir.create(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/sigma/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/sigma/",dataset,"_",level_name,"_",ncbi_only, ".png"), p6, width=20, height=20, units = 'cm', dpi=1000)
}
  ...
  for (dataset in list.files("analysis/simulation_outputs")) {
    for (level in 1:7) {
      ...
      level_name <- case_when(level == 1 ~ "kingdom",
                              ...
                              level == 6 ~ "genus",
                              level == 7 ~ "species")
      if (!file.exists(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/sigma/",dataset,"_",level_name,"_", "NCBI_only", ".png"))) {
        bray_vs_parameter_individual(dataset, level)
      }
      if (!file.exists(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/sigma/",dataset,"_",level_name,"_", "all_taxa", ".png"))) {
...
f1_vs_parameter_individual <- function(dataset, level, ncbi_only=TRUE, metric="F1") {
  ...
  ncbi_only <- ifelse(ncbi_only, "NCBI_only", "all_taxa")
  dir.create(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/n/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/n/",dataset,"_",level_name,"_",ncbi_only, ".png"), p1, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/sample_size/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/sample_size/",dataset,"_",level_name,"_",ncbi_only, ".png"), p2, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/unknown_prop/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/unknown_prop/",dataset,"_",level_name,"_",ncbi_only, ".png"), p3, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/mut_rate/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/mut_rate/",dataset,"_",level_name,"_",ncbi_only, ".png"), p4, width=20, height=20, units = 'cm', dpi=1000)
  ...
  dir.create(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/k/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/k/",dataset,"_",level_name,"_",ncbi_only, ".png"), p5, width=20, height=20, units = 'cm', dpi=1000)
  ...
  p6 <- ggplot(f1_df[f1_df$n==default_params["n"] & f1_df$sample_size==default_params["sample_size"] & f1_df$unknown==default_params["unknown"] & f1_df$k==default_params["k"] & f1_df$mut_rate==default_params["mut_rate"],], 
    ...
    theme(text=element_text(size=12),
          ...
          legend.text = element_text(size=10)) + 
    guides(color=guide_legend(title="Tool"))
  dir.create(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/sigma/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/sigma/",dataset,"_",level_name,"_",ncbi_only, ".png"), p6, width=20, height=20, units = 'cm', dpi=1000)
}
  ...
  for (dataset in list.files("analysis/simulation_outputs")) {
    for (level in 1:7) {
      ...
      level_name <- case_when(level == 1 ~ "kingdom",
                              ...
                              level == 6 ~ "genus",
                              level == 7 ~ "species")
      if (!file.exists(paste0("analysis/figure2/F1_vs_parameter/",dataset,"/sigma/",dataset,"_",level_name,"_", "NCBI_only", ".png"))) {
      ...
      if (!file.exists(paste0("analysis/figure2/F1_vs_parameter/",dataset,"/sigma/",dataset,"_",level_name,"_", "all_taxa", ".png"))) {
...
genome_size_densities <- function(dataset) {
  ...
  dir.create(paste0("analysis/figure2/genome_skew/"), showWarnings = FALSE, recursive = T)
  ggsave(paste0("analysis/figure2/genome_skew/",dataset,".png"), p1, width=15, height=12, units = 'cm', dpi=1000)
}
...
unknown_evaluation <- function(dataset, level, core_only = TRUE) {
  ...
  dir.create(file.path("analysis/figure2/unknown_evaluation/",dataset,"/"), showWarnings = FALSE)
  if (core_only) {
    ggsave(paste0("analysis/figure2/unknown_evaluation/",dataset,"/",dataset,"_",level_name,".png"), width=14, height=26, units = 'cm', dpi=1000)
  } else {
    ggsave(paste0("analysis/figure2/unknown_evaluation/",dataset,"/",dataset,"_",level_name,"_all_tools.png"), width=24, height=24, units = 'cm', dpi=1000)
  }
}
...
grid_analysis <- function(dataset, level, ncbi_only = TRUE) {
  ...
  ncbi_only <- ifelse(ncbi_only, "NCBI_only", "all_taxa")
  dir.create(file.path("analysis/figure2/simulation_structure_grid/",dataset,"/"), showWarnings = FALSE)
  ggsave(paste0("analysis/figure2/simulation_structure_grid/",dataset,"/",dataset,"_",level_name,"_", ncbi_only, ".png"), width=10, height=36, units = 'cm', dpi=1000, bg='#ffffff')
  ...
  ggsave(paste0("analysis/figure2/simulation_structure_grid/",dataset,"/",dataset,"_",level_name,"_", ncbi_only, "_core.png"), width=10, height=36, units = 'cm', dpi=1000, bg='#ffffff')
}
  ...
  for (dataset in list.files("analysis/simulation_outputs")) {
    for (level in c(7)) {
      ...
      level_name <- case_when(level == 1 ~ "kingdom",
                              ...
                              level == 6 ~ "genus",
                              level == 7 ~ "species")
      if (!file.exists(paste0("analysis/figure2/simulation_structure_grid/",dataset,"/",dataset,"_",level_name,"_all_taxa.png"))) {
...
f1_vs_parameter_merged <- function(dataset, level, ncbi_only=TRUE, metric="F1") {
  ...
  ncbi_only <- ifelse(ncbi_only, "NCBI_only", "all_taxa")
  dir.create(file.path("analysis/figure2/", metric, "_vs_parameter/",dataset,"/merged/"), showWarnings = FALSE)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/merged/",dataset,"_",level_name,"_", ncbi_only, ".png"), g, width=44, height=10, units = 'cm', dpi=1000, bg='#ffffff')
}
...
f1_vs_parameter_merged_heatmap <- function(dataset, level, ncbi_only=TRUE, metric="F1") {
  ...
  dir.create(file.path("analysis/figure2/", metric, "_vs_parameter/",dataset,"/merged/"), showWarnings = FALSE)
  ggsave(paste0("analysis/figure2/", metric, "_vs_parameter/",dataset,"/merged/",dataset,"_",level_name,"_", ncbi_only, "_heatmap.png"), g, width=50, height=14, units = 'cm', dpi=1000, bg='#ffffff')
}
...
bray_vs_parameter_merged <- function(dataset, level, ncbi_only=TRUE) {
  ...
  dir.create(file.path("analysis/figure2/bray_vs_parameter/",dataset,"/merged/"), showWarnings = FALSE)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/merged/",dataset,"_",level_name,"_", ncbi_only, ".png"), g, width=44, height=10, units = 'cm', dpi=1000, bg='#ffffff')
}
...
bray_vs_parameter_merged_heatmap <- function(dataset, level, ncbi_only=TRUE) {
  ...
  p1 <- bray_df[bray_df$sample_size==default_params["sample_size"] & bray_df$unknown==default_params["unknown"] & bray_df$k==default_params["k"] & bray_df$sigma==default_params["sigma"] & bray_df$mut_rate==default_params["mut_rate"],] %>%
    ...
    scale_fill_gradient2(low = "white", high = "red", mid = "#FFBBBB", midpoint = 0.5,
                         limit = c(0,1), 
                         name=paste0("1 - Jaccard Dissimilarity\nat the ", level_name, " level")) +
    theme_classic() + 
    xlab("Species count") + 
    theme(text=element_text(size=16),
          plot.margin = unit(c(1,0,1,0), "cm"),
  ...
  dir.create(file.path("analysis/figure2/bray_vs_parameter/",dataset,"/merged/"), showWarnings = FALSE)
  ggsave(paste0("analysis/figure2/bray_vs_parameter/",dataset,"/merged/",dataset,"_",level_name,"_", ncbi_only, "_heatmap.png"), g, width=50, height=14, units = 'cm', dpi=1000, bg='#ffffff')
}
...
assess_reconstructed <- function(dataset, core_only = TRUE) {
  ...
  dir.create(file.path("analysis/figure2/reconstructed_vs_parameter/",dataset,"/merged/"), showWarnings = FALSE)
  if (core_only) {
    g <- arrangeGrob(
      grobs = list(p1, p2, p3, p4),
      heights = c(1, 1.25, 1, 3.1), ncol = 1)
    ggsave(paste0("analysis/figure2/reconstructed_vs_parameter/",dataset,"/merged/",dataset,".png"), g, width=9, height=36, units = 'cm', dpi=1000, bg='#ffffff')
  } else {
    g <- arrangeGrob(
      grobs = list(p1, p2, p3, p6, p5, p4),
      heights = c(1, 1.25, 1, 1, 0.75, 3.1), ncol = 1)
    ggsave(paste0("analysis/figure2/reconstructed_vs_parameter/",dataset,"/merged/",dataset,"_all_tools.png"), g, width=9, height=50, units = 'cm', dpi=1000, bg='#ffffff')
  }
}
